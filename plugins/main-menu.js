...
╰─━━━━━━━━━━━╯`
    ...
    // Preparar video como fake GIF
    let media = await prepareWAMessageMedia({ video: fs.readFileSync(videoPath), gifPlayback: true }, { upload: conn.waUploadToServer })
    ...
    const msg = generateWAMessageFromContent(m.chat, { interactiveMessage }, { 
      ...
      quoted: m, 
      contextInfo: { mentionedJid: [userId] } // <--- mención real
    })
